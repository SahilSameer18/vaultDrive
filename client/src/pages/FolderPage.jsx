...
export default function FolderPage() {
  ...
  const { files, loading: filesLoading, sortBy, sortOrder, page, limit, pagination, setSortBy, setSortOrder, setPage, setLimit, fetchFiles, uploadFile, togglePrivacy, deleteFile, renameFile, updateFileInState } = useFiles(folderId);
    ...
    <div className="space-y-6 fade-in select-none pb-20">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-vault-border">
        <div>
          ...
          <h1 className="text-xl font-bold tracking-tight text-vault-text mt-1">
