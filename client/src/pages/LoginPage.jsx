      ...
      <div className="w-full min-h-screen grid grid-cols-1 lg:grid-cols-2 relative z-10">
        ...
        <div className="hidden lg:flex flex-col justify-between p-12 xl:p-16 border-r border-[#2A2E37] bg-gradient-to-b from-[#1C1F26]/70 to-[#14161A] backdrop-blur-xl relative">
          ...
          <div className="my-auto py-12 max-w-md">
            ...
            <h2 className="text-3xl xl:text-4xl font-bold tracking-tight text-[#E8E6E0] leading-snug mb-6">
              Your assets, protected by military-grade vault encryption.
            </h2>

            {/* Clean Minimal List */}
            <div className="space-y-5 text-sm text-[#8B8F99]">
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-[#6FA88A]" />
                <span>JWT Refresh Token Rotation & HTTP-Only Cookies</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-[#B8935A]" />
                <span>Cycle-Guarded Multi-Level Subfolders</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-[#38BDF8]" />
                <span>Instant Media Streaming & QR Code Links</span>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-center items-center p-8 sm:p-12 lg:p-16 min-h-screen">
          ...
          <div className="w-full max-w-md fade-in my-auto">
            ...
            {/* Header */}
            <div className="mb-8">
              <h1 className="text-3xl font-bold tracking-tight text-[#E8E6E0] mb-2">Welcome Back</h1>
              <p className="text-sm text-[#8B8F99]">Sign in to unlock your encrypted file vault</p>
            </div>
            ...
            <div className="p-8 sm:p-10 rounded-2xl bg-[#1C1F26] border border-[#2A2E37] shadow-2xl shadow-black/80">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  type="submit"
                  disabled={loading}
                  className="w-full py-3.5 px-4 rounded-xl text-sm font-semibold text-[#14161A] bg-gradient-to-r from-[#B8935A] to-[#C8A66B] hover:brightness-110 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg"
                >
