      ...
      <div className="relative w-full max-w-md rounded-2xl border border-[var(--theme-border)] bg-[var(--theme-panel)] p-6 shadow-2xl z-10 animate-scale-up">
        ...
        <div className="flex items-center justify-between border-b border-[var(--theme-border)] pb-4 mb-4">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="font-bold text-base text-[var(--theme-text)]">Create Directory</h3>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g. Cryptographic Keys & Reports"
              autoFocus
              required
              className="w-full px-4 py-2.5 rounded-xl bg-[var(--theme-surface)] border border-[var(--theme-border)] text-[var(--theme-text)] text-sm placeholder:text-[var(--theme-text-muted)]/40 focus:border-[var(--theme-accent)] focus:outline-none shadow-inner transition-colors"
            />
          </div>
          ...
          <div className="flex items-center justify-end gap-2.5 pt-2">
            ...
            >
              {loading ? "Allocating..." : "Create Directory"}
            </button>
          </div>
        </form>
      </div>
