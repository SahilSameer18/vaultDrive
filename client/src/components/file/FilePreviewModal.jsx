      ...
      <div className="relative z-[100000] w-full max-w-5xl h-[88vh] rounded-2xl border border-[var(--theme-border)] bg-[var(--theme-panel)] flex flex-col shadow-[0_24px_80px_rgba(0,0,0,0.85)] overflow-hidden animate-scale-up">
        ...
        <div className="px-5 py-3.5 border-b border-[var(--theme-border)] flex items-center justify-between bg-[var(--theme-surface)] shrink-0">
          <div className="flex items-center gap-3 min-w-0 flex-1 pr-4">
            <div className="w-9 h-9 rounded-xl bg-[var(--theme-panel)] border border-[var(--theme-accent)]/40 flex items-center justify-center text-[var(--theme-accent)] shrink-0 shadow-sm">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                ...
                <span className="hidden sm:inline-block px-1.5 py-0.5 rounded text-[8px] font-mono font-bold tracking-wider bg-[var(--theme-panel)] border border-[var(--theme-border)] text-[var(--theme-accent)]">
                  {fileExt}
                </span>
              </div>
          ...
          <div className="flex items-center gap-2.5 shrink-0">
            <button
              ...
              className="px-3.5 py-1.5 rounded-xl border border-[var(--theme-accent)]/40 bg-[var(--theme-accent)]/10 text-[var(--theme-accent)] text-xs font-mono font-semibold hover:bg-[var(--theme-accent)] hover:text-[#0d0f12] transition-all flex items-center gap-2 cursor-pointer shadow-sm"
              title="Download File"
            >
            ...
            <button
              type="button"
              onClick={onClose}
              className="w-8 h-8 rounded-xl border border-[var(--theme-border)] bg-[var(--theme-panel)] text-[var(--theme-text-muted)] hover:text-[var(--theme-text)] hover:border-[var(--theme-accent)] flex items-center justify-center transition-colors cursor-pointer"
          ...
          {mediaError ? (
            <div className="text-center py-12 space-y-4 max-w-md">
              ...
              <button
                type="button"
                onClick={() => handleFileDownload(file.url, file.name)}
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-semibold text-[#0d0f12] bg-[var(--theme-accent)] hover:brightness-110 transition-all shadow-md cursor-pointer font-mono"
              >
            ...
            <div className="w-full max-w-md p-8 rounded-2xl border border-[var(--theme-border)] bg-[var(--theme-panel)] text-center shadow-2xl space-y-6">
              <div className="w-20 h-20 rounded-full bg-[var(--theme-accent)]/10 border border-[var(--theme-accent)]/30 flex items-center justify-center text-[var(--theme-accent)] mx-auto relative shadow-inner">
                <div className="w-12 h-12 rounded-full border border-dashed border-[var(--theme-accent)]/50 animate-spin flex items-center justify-center" style={{ animationDuration: "12s" }}>
            ...
            isGatekeeperUrl ? (
              <div className="text-center py-12 space-y-4 max-w-md">
                <div className="w-16 h-16 rounded-2xl bg-[var(--theme-panel)] border border-[var(--theme-border)] flex items-center justify-center text-[var(--theme-accent)] mx-auto shadow-lg">
            ...
            <div className="w-full h-full p-4 rounded-xl border border-[var(--theme-border)] bg-[var(--theme-surface)] overflow-auto font-mono text-xs text-[var(--theme-text)]">
              {loadingText ? (
                <div className="py-12 text-center text-[var(--theme-text-muted)] flex items-center justify-center gap-2">
                  ...
                  <span>Loading syntax stream...</span>
                </div>
              ) : (
            ...
            <div className="text-center py-12 space-y-4 max-w-md">
              ...
              <div className="flex items-center justify-center gap-3 pt-2">
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="px-4 py-2.5 rounded-xl border border-[var(--theme-border)] text-xs font-mono text-[var(--theme-text-muted)] hover:text-[var(--theme-text)] hover:border-[var(--theme-accent)] transition-colors cursor-pointer"
                >
                  Close Modal
                </button>
              </div>
